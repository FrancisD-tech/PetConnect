	...
	<div class="flex justify-center self-center  z-10">
		<div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
			<div class="mb-7">
                ...
                <p>Enter your email, and we'll send a code to your inbox.</p>
			</div>
			<div class="space-y-6">
				<div class="">
                ...
                <!--
					...
					<div>
						<button type="submit" onclick="location.href='../homepage.php'" class="w-full flex justify-center bg-purple-800  hover:bg-purple-700 text-gray-100 p-3  rounded-lg tracking-wide font-semibold  cursor-pointer transition ease-in duration-500" >
                Reset Password
              </button>
					</div>
                    <!--
