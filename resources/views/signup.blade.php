		...
		<div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
			...
			<div class="space-y-6">
				<div class="">
                    ...
                    <div class="relative" x-data="{ show: true }">
						<input placeholder="Confirm Password" :type="show ? 'password' : 'text'" class="text-sm text-gray-200 px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-purple-400">
						<div class="flex items-center absolute inset-y-0 right-0 mr-3  text-sm leading-5">
					...
					<div>
						<button type="submit" onclick="location.href='login'" class="w-full flex justify-center bg-purple-800  hover:bg-purple-700 text-gray-100 p-3  rounded-lg tracking-wide font-semibold  cursor-pointer transition ease-in duration-500"
                        >
                Sign Up
              </button>
					</div>
             ...
             <span>Google</span>
               ...
               <span>Facebook</span>
				...
				<div class="mt-7 text-center text-gray-300 text-xs">
					<span>
                Copyright © 2021-2023
                <a href="https://francisd-tech.github.io/Portfolio_Canoy/" rel="" target="_blank" title="Codepen aji" class="text-purple-500 hover:text-purple-600 ">Francis</a></span>
				</div>
			</div>
		</div>
	</div>
