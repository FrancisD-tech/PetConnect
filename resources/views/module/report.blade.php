...
<section class="hero">
    <div>
        ...
        <p>Help us bring your furry friend back home. Fill out the details below.</p>
    </div>
    <div class="wave-bottom"></div>
</section>

<section style="max-width: 800px; margin: 0 auto;">
    <h2 class="section-title">Lost Pet Form</h2>
    <form style="background:#f9f9f9; padding:40px; border-radius:20px; color:#333;">
        <div style="margin-bottom:20px;">
            <label>Pet Name</label><br>
            <input type="text" style="width:100%; padding:12px; border-radius:8px; border:1px solid #ccc; margin-top:8px;">
        </div>
        <div style="margin-bottom:20px;">
            <label>Species</label><br>
            <select style="width:100%; padding:12px; border-radius:8px; margin-top:8px;">
