...
<head>
    ...
    <!-- Tailwind CDN for your exact login popup -->
...
<section class="hero">
    <div>
        <h1>Get in Touch</h1>
        <p>We’re here to help you and your pet</p>
    </div>
    <div class="wave-bottom"></div>
</section>

<section style="max-width:1000px; margin:0 auto; display:grid; grid-template-columns:1fr 1fr; gap:50px;">
    <div>
        <h2 class="section-title">Send us a Message</h2>
        <form style="background:#f9f9f9; padding:30px; border-radius:15px; color:#333;">
            <input type="text" placeholder="Your Name" style="width:100%; padding:12px; margin-bottom:15px; border-radius:8px; border:1px solid #ddd;">
            <input type="email" placeholder="Your Email" style="width:100%; padding:12px; margin-bottom:15px; border-radius:8px; border:1px solid #ddd;">
            <textarea placeholder="Your Message" rows="6" style="width:100%; padding:12px; margin-bottom:15px; border-radius:8px; border:1px solid #ddd;"></textarea>
            <button type="submit" class="btn" style="width:100%;">Send Message</button>
        </form>
    </div>
    <div style="color:#333;">
        <h2 class="section-title">Contact Info</h2>
        <p style="margin-bottom:20px; font-size:1.1rem;"><i class="fas fa-envelope" style="color:var(--primary); margin-right:10px;"></i> PetConnect@gmail.com</p>
        <p style="margin-bottom:20px; font-size:1.1rem;"><i class="fas fa-phone" style="color:var(--primary); margin-right:10px;"></i> +63 9280485536</p>
        <p style="margin-bottom:40px; font-size:1.1rem;"><i class="fas fa-map-marker-alt" style="color:var(--primary); margin-right:10px;"></i> brgy kaymito Sanito Ipil ZS</p>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3952.613288314039!2d122.584515314783!3d7.783335994366!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3256775f0c5b5f0d%3A0x8f8e8f8e8f8e8f8e!2sBrgy%20Kaymito%2C%20Sanito%2C%20Ipil%2C%20Zamboanga%20Sibugay!5e0!3m2!1sen!2sph!4v1690000000000" width="100%" height="300" style="border:0; border-radius:15px;" allowfullscreen="" loading="lazy"></iframe>
    </div>
</section>
...
<!-- YOUR EXACT TAILWIND LOGIN POPUP -->
<div id="loginModal">
    <div class="relative min-h-screen sm:flex sm:flex-row justify-center bg-transparent rounded-3xl shadow-xl max-w-4xl w-full mx-4">
        <button onclick="document.getElementById('loginModal').classList.remove('active')"
                class="absolute top-4 right-4 text-white text-4xl z-50">&times;</button>
        <div class="flex justify-center self-center z-10">
            <div class="p-12 bg-white mx-auto rounded-3xl w-96">
                ...
                <div class="space-y-6">
                    ...
                    <div class="relative">
                        <input placeholder="Password" type="password" id="password" class="text-sm px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-purple-400">
                        <div class="flex items-center absolute inset-y-0 right-0 mr-3 text-sm leading-5">
                            <svg onclick="document.getElementById('password').type='text'" class="h-4 text-purple-700 cursor-pointer" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                ...
                <div class="mt-7 text-center text-gray-300 text-xs">
                    <span>Copyright © 2025-2026 PetConnect. Made with Purkiki.</span>
                </div>
            </div>
        </div>
    </div>
