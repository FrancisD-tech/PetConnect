    ...
    <aside class="sidebar">
        <div class="p-6">
            ...
            <nav class="space-y-2">
                ...
                <a href="dashboardL" class="flex items-center gap-4 px-4 py-3 rounded-xl hover:bg-purple-100 text-gray-700 font-medium">Lost Pets</a>
    ...
    <main class="main-content p-6 pt-20 md:pt-8">
        <div class="max-w-7xl mx-auto text-center">
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-16">
                <div class="stat-card"><div class="text-6xl mb-4">128</div><p class="text-2xl font-bold">128</p><p>Pets Available</p></div>
                <div class="stat-card"><div class="text-6xl mb-4">1,247</div><p class="text-2xl font-bold">1,247</p><p>Happy Adoptions</p></div>
                <div class="stat-card"><div class="text-6xl mb-4">4.9</div><p class="text-2xl font-bold">4.9 ★</p><p>Community Rating</p></div>
            </div>

            <a href="index" class="inline-block px-16 py-8 bg-gradient-to-r from-purple-600 to-pink-600 text-3xl font-bold rounded-full shadow-2xl hover:shadow-purple-500/50 transition transform hover:scale-105">
                Browse All Pets
            </a>
        </div>
    </main>
